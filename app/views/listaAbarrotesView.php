...
<head>
    ...
    <title>Registro de Abarrotes</title>
    <style>
        .search-container {
            display: flex;
...
<body>
    ...
    <div class="cuerpo">
        <h2 class="titulo-general">Lista de Abarrotes</h2>
        <p class="subtitulo-general">Administración de los abarrotes registrados</p>

        <div class="search-container">
            <input type="text" id="searchInput" placeholder="Buscar por nombre..." aria-label="Buscar abarrotes" />
        </div>
            ...
            <table>
                ...
                <tbody id="clientesTableBody">
                    <?php foreach ($abarrotes as $abarrote) : ?>
                        <tr class="elementos">
                            <td><?php echo ($abarrote->getCod_prod()) ?></td>
                            <td><?php echo ($abarrote->getNom_prod()) ?></td>
                            <td style="text-align: center;">
                                <button type="button" class="edit" data-bs-toggle="modal" data-bs-target="#crearModal" data-id="<?php echo ($abarrote->getCod_prod()); ?>">
                                    <span class="material-icons" style="color: #0869fa;">edit</span>
                                </button>
                            </td>
                            <td style="text-align: center;">
                                <button type="button" class="btn-delete" data-id="<?php echo ($abarrote->getCod_prod()); ?>" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal" style="background: none; border: none; cursor: pointer;">
        ...
        <button type="button" class="create" data-bs-toggle="modal" data-bs-target="#crearModal" id="openModal">
            <span class="material-icons" style="color: white;">add</span>Añadir Abarrote
        </button>
    </div>
    ...
    <script src="../public/js/abarrotesView.js"></script>
</body>

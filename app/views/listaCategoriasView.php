...
<body>
    ...
    <div class="cuerpo">
        <h2 class="titulo-general">Lista de Categorias</h2>
        <p class="subtitulo-general">Administración de las categorias de servicios</p>
                ...
                <div class="card" onclick="event.stopPropagation();">
                    ...
                    <!-- <div class="card-id">
                        <p class="client-id">
                            ...
                            <?php #echo ($categoria->getCod_categoria()) ?>
                        </p>
                    </div>
                    ...
                    <div class="card-details">
                        <div class="card-detail">
                            ...
                            <p><?php #echo ($categoria->getDscr()) ?></p>
                        </div>
                    </div> -->

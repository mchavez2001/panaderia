...
<head>
    ...
    <title>Lista de Abarrotes Vendidos por Cliente</title>
</head>
...
<body>
    ...
    <div class="cuerpo">
        ...
        <button type="button" class="create" data-id="<?php echo ($cod_venta); ?>" data-bs-toggle="modal" data-bs-target="#crearModal" id="openModal">
            <span class="material-icons" style="color: white;">add</span>Agregar Abarrote
        </button>
    </div>

    <script src="../public/js/productoVentaAbarroteView.js"></script>
</body>

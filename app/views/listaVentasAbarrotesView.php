 ...
 <body>
                 ...
                 <tbody id="ventasTableBody">
                     <?php foreach ($ventas as $venta) : ?>
                         ...
                         <tr class="elementos">
                             ...
                             <td>
                                 <form action="/panaderia/public/producto_venta_abarrote" method="get">
             ...
             <?php foreach ($ventas as $venta) : ?>
                 <div class="card" onclick="event.stopPropagation();">
                     ...
                     <div class="card-actions">
                         ...
                         <form action="/panaderia/public/producto_venta_abarrote" method="get" style="display:inline;">
                             <input type="hidden" name="id" value="<?php echo ($venta->getCod_venta()); ?>">
     ...
     <script src="../public/js/ventasAbarrotesView.js"></script>
 </body>
